...
# Paket yöneticileri
npm i -g codeabz@latest        # veya bun/pnpm/yarn
scoop install codeabz             # Windows
choco install codeabz             # Windows
brew install anomalyco/tap/codeabz # macOS ve Linux (önerilir, her zaman güncel)
brew install codeabz              # macOS ve Linux (resmi brew formülü, daha az güncellenir)
sudo pacman -S codeabz            # Arch Linux (Stable)
paru -S codeabz-bin               # Arch Linux (Latest from AUR)
mise use -g codeabz               # Tüm işletim sistemleri
nix run nixpkgs#codeabz           # veya en güncel geliştirme dalı için github:Abdul-Basit-Zahid/codeabz
```
...
codeabz ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/Abdul-Basit-Zahid/codeabz/releases) veya [github.com/Abdul-Basit-Zahid/codeabz/download](https://github.com/Abdul-Basit-Zahid/codeabz/download) adresinden indirebilirsiniz.
...
1. `$codeabz_INSTALL_DIR` - Özel kurulum dizini
2. `$XDG_BIN_DIR` - XDG Base Directory Specification uyumlu yol
3. `$HOME/bin` - Standart kullanıcı binary dizini (varsa veya oluşturulabiliyorsa)
4. `$HOME/.codeabz/bin` - Varsayılan yedek konum
...
codeabz, `Tab` tuşuyla aralarında geçiş yapabileceğiniz iki yerleşik (built-in) ajan içerir.
...
[Ajanlar](https://github.com/Abdul-Basit-Zahid/codeabz/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

codeabz'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://github.com/Abdul-Basit-Zahid/codeabz/docs).

### Katkıda Bulunma

codeabz'a katkıda bulunmak istiyorsanız, lütfen bir pull request göndermeden önce [katkıda bulunma dokümanlarımızı](./CONTRIBUTING.md) okuyun.

### codeabz Üzerine Geliştirme

codeabz ile ilgili bir proje üzerinde çalışıyorsanız ve projenizin adının bir parçası olarak "codeabz" kullanıyorsanız (örneğin, "codeabz-dashboard" veya "codeabz-mobile"), lütfen README dosyanıza projenin codeabz ekibi tarafından geliştirilmediğini ve bizimle hiçbir şekilde bağlantılı olmadığını belirten bir not ekleyin.

---

**Topluluğumuza katılın** [Discord](https://discord.gg/codeabz) | [X.com](https://x.com/codeabz)
