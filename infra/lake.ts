...
const tableBucketName = `codeabz-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `codeabz-${$app.stage}-lake-ingest`,
    destination: "iceberg",
