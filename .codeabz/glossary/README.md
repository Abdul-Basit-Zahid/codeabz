...
Use this folder for locale-specific translation guidance that supplements `.codeabz/agent/translator.md`.
...
- PR #12345: https://github.com/Abdul-Basit-Zahid/codeabz/pull/12345

## Do Not Translate (Locale Additions)

- `codeabz` (preserve casing)
