...
- PR #10018: https://github.com/Abdul-Basit-Zahid/codeabz/pull/10018
- PR #12935: https://github.com/Abdul-Basit-Zahid/codeabz/pull/12935

## Do Not Translate (Locale Additions)

- `codeabz` (preserve casing in prose; keep `codeabz` only in commands, package names, paths, or code)
- `codeabz CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
