...
- PR #13942: https://github.com/Abdul-Basit-Zahid/codeabz/pull/13942

## Do Not Translate (Locale Additions)

- `codeabz` (preserve casing in prose; keep `codeabz` only when it is part of commands, package names, paths, or code)
- `codeabz Zen`
- `codeabz CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `codeabz` in prose when referring to the product name; use `codeabz`
