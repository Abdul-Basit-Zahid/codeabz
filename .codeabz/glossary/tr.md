...
- PR #15835: https://github.com/Abdul-Basit-Zahid/codeabz/pull/15835

## Do Not Translate (Locale Additions)

- `codeabz` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `codeabz` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `codeabz` in prose, `codeabz` only for exact technical identifiers
...
- Avoid changing `codeabz` to `codeabz` inside commands, URLs, package names, or code literals
