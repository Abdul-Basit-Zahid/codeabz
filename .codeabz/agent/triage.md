...
Desktop application and browser-based app issues, including `codeabz web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core codeabz server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

codeabz Zen, codeabz Go, and billing issues.
