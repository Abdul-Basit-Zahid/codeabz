...
npm i -g codeabz@latest        # o bun/pnpm/yarn
scoop install codeabz             # Windows
choco install codeabz             # Windows
brew install anomalyco/tap/codeabz # macOS y Linux (recomendado, siempre al día)
brew install codeabz              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S codeabz            # Arch Linux (Stable)
paru -S codeabz-bin               # Arch Linux (Latest from AUR)
mise use -g codeabz               # cualquier sistema
nix run nixpkgs#codeabz           # o github:Abdul-Basit-Zahid/codeabz para la rama dev más reciente
```
...
codeabz también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases) o desde [github.com/Abdul-Basit-Zahid/codeabz/download](https://github.com/Abdul-Basit-Zahid/codeabz/download).
...
1. `$codeabz_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.codeabz/bin` - Alternativa por defecto
...
codeabz incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://github.com/Abdul-Basit-Zahid/codeabz/docs/agents).

### Documentación

Para más información sobre cómo configurar codeabz, [**ve a nuestra documentación**](https://github.com/Abdul-Basit-Zahid/codeabz/docs).

### Contribuir

Si te interesa contribuir a codeabz, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en codeabz

Si estás trabajando en un proyecto basado en codeabz y usas "codeabz" como parte del nombre, por ejemplo, "codeabz-dashboard" u "codeabz-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de codeabz y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/codeabz) | [X.com](https://x.com/codeabz)
