...
brew install anomalyco/tap/codeabz # macOS og Linux (anbefalt, alltid oppdatert)
brew install codeabz              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
codeabz er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/Abdul-Basit-Zahid/codeabz/releases) eller [github.com/Abdul-Basit-Zahid/codeabz/download](https://github.com/Abdul-Basit-Zahid/codeabz/download).
...
1. `$codeabz_INSTALL_DIR` - Egendefinert installasjonsmappe
...
codeabz har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://github.com/Abdul-Basit-Zahid/codeabz/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer codeabz, [**se dokumentasjonen**](https://github.com/Abdul-Basit-Zahid/codeabz/docs).

### Bidra

Hvis du vil bidra til codeabz, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på codeabz

Hvis du jobber med et prosjekt som er relatert til codeabz og bruker "codeabz" som en del av navnet; for eksempel "codeabz-dashboard" eller "codeabz-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av codeabz-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/codeabz) | [X.com](https://x.com/codeabz)
