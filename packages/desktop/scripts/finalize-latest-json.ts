...
const releaseId = process.env.CODEABZ_RELEASE
if (!releaseId) throw new Error("CODEABZ_RELEASE is required")

const version = process.env.CODEABZ_VERSION
if (!version) throw new Error("CODEABZ_VERSION is required")
...
const macxTarGz = "codeabz-desktop-mac-x64.app.tar.gz"
const macaTarGz = "codeabz-desktop-mac-arm64.app.tar.gz"
