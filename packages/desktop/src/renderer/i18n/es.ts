export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de codeabz",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de codeabz. ¿Quieres instalarla y reiniciar?",
