...
export const TypeId: TypeId = "~@codeabz/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@codeabz/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@codeabz/effect-sqlite-node/NodeSqliteClient")
