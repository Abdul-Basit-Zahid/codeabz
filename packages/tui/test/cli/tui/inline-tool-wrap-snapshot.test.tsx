...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "codeabz.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/codeabz/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/codeabz (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/codeabz/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/codeabz/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CODEABZ_DB|CODEABZ_DB|CODEABZ_DEV|Global\\.Path\\.data|data =" in packages/codeabz/src (115 matches)',
  },
] as const
