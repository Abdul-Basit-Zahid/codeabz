...
import { registercodeabzSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@codeabz/sdk/v2"
...
import { CODEABZ_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, usecodeabzKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.CODEABZ_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
