...
import defaultSoundPath from "@codeabz/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@codeabz/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@codeabz/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@codeabz/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@codeabz/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@codeabz/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "codeabz"
const DEFAULT_PACK_ID = "codeabz.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "codeabz Default",
  builtin: true,
  sounds: {
