import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@codeabz/sdk/v2"
import { SessionTurn } from "@codeabz/session-ui/session-turn"
import { SessionReview } from "@codeabz/session-ui/session-review"
import { DataProvider } from "@codeabz/session-ui/context"
import { FileComponentProvider } from "@codeabz/ui/context/file"
import { WorkerPoolProvider } from "@codeabz/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@codeabz/ui/logo"
import { IconButton } from "@codeabz/ui/icon-button"
import { ProviderIcon } from "@codeabz/ui/provider-icon"
import { iife } from "@codeabz/core/util/iife"
import { Binary } from "@codeabz/core/util/binary"
import { NamedError } from "@codeabz/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@codeabz/ui/tabs"
import { MessageNav } from "@codeabz/session-ui/message-nav"
import { FileSSR } from "@codeabz/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@codeabz/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/codeabz-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | codeabz</Title>
              </Show>
              <Meta name="description" content="codeabz - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/Abdul-Basit-Zahid/codeabz"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://github.com/Abdul-Basit-Zahid/codeabz/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
