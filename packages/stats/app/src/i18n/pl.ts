export const dict = {
  "app.title": "Rankingi użycia modeli AI | codeabz Data",
  "app.description":
    "Przeglądaj użycie codeabz Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny codeabz Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę codeabz na GitHub",
  "header.github": "GitHub",
  "header.trycodeabz": "Wypróbuj codeabz",
  ...
  "footer.homeAria": "Strona główna codeabz",
  ...
  "home.topModelsDescription": "Użycie modeli w codeabz Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy codeabz Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | codeabz Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w codeabz Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia codeabz.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w codeabz",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia codeabz",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów codeabz z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | codeabz Data",
  "model.description":
    "Zobacz dane użycia {{model}} w codeabz Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie codeabz Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu codeabz Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu codeabz Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia codeabz Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny codeabz Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia codeabz Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów codeabz Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy codeabz Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji codeabz Go.",
  ...
  "model.geoDescription": "Tokeny modelu codeabz Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne codeabz Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów codeabz Go.",
