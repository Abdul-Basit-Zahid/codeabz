export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | codeabz Data",
  "app.description":
    "Explora el uso de codeabz Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de codeabz Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a codeabz en GitHub",
  "header.github": "GitHub",
  "header.trycodeabz": "Probar codeabz",
  ...
  "footer.homeAria": "Inicio de codeabz",
  ...
  "modal.title": "Boletín de codeabz",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en codeabz Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de codeabz Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | codeabz Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en codeabz Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de codeabz.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en codeabz",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de codeabz",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de codeabz durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | codeabz Data",
  "model.description":
    "Consulta datos de uso de {{model}} en codeabz Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de codeabz Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de codeabz Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de codeabz Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de codeabz Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de codeabz Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de codeabz Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de codeabz Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de codeabz Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de codeabz Go.",
  ...
  "model.geoDescription": "Tokens del modelo de codeabz Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de codeabz Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de codeabz Go.",
