export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | codeabz Data",
  "app.description":
    "Explorez l'utilisation d'codeabz Go par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel codeabz Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à codeabz sur GitHub",
  "header.github": "GitHub",
  "header.trycodeabz": "Essayer codeabz",
  ...
  "footer.homeAria": "Accueil codeabz",
  ...
  "modal.title": "Newsletter codeabz",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans codeabz Go.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'codeabz Go par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | codeabz Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans codeabz Go, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'codeabz.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans codeabz",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'codeabz",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens codeabz sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | codeabz Data",
  "model.description":
    "Consultez les données d'utilisation codeabz Go de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation codeabz Go apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation codeabz Go de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation codeabz Go de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation codeabz Go dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens codeabz Go récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation codeabz Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens codeabz Go sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'codeabz Go sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions codeabz Go.",
  ...
  "model.geoDescription": "Tokens du modèle codeabz Go utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique codeabz Go ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens codeabz Go.",
