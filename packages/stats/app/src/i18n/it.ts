export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | codeabz Data",
  "app.description":
    "Esplora l'utilizzo di codeabz Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo codeabz Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a codeabz su GitHub",
  "header.github": "GitHub",
  "header.trycodeabz": "Prova codeabz",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in codeabz Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di codeabz Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | codeabz Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in codeabz Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di codeabz.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in codeabz",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di codeabz",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token codeabz negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | codeabz Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in codeabz Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di codeabz Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo codeabz Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo codeabz Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di codeabz Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di codeabz Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di codeabz Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token codeabz Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di codeabz Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione codeabz Go.",
  ...
  "model.geoDescription": "Token del modello codeabz Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica codeabz Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token codeabz Go.",
