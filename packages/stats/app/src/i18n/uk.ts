export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | codeabz Data",
  "app.description":
    "Досліджуйте використання codeabz Go серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  "app.unfurlAlt": "Словесний знак codeabz Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку codeabz на GitHub",
  "header.github": "GitHub",
  "header.trycodeabz": "Спробувати codeabz",
  ...
  "footer.homeAria": "Головна codeabz",
  ...
  "home.topModelsDescription": "Використання моделей в codeabz Go.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі codeabz Go за моделлю.",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | codeabz Data",
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в codeabz Go, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  "lab.loadingTitle": "Лабораторія моделей",
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання codeabz.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в codeabz",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання codeabz",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів codeabz за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | codeabz Data",
  "model.description":
    "Перегляньте дані використання {{model}} в codeabz Go, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання codeabz Go з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні codeabz Go за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні codeabz Go за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання codeabz Go в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени codeabz Go, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання codeabz Go.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів codeabz Go за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі codeabz Go за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу codeabz Go.",
  ...
  "model.geoDescription": "Токени моделі codeabz Go, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки codeabz Go не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів codeabz Go.",
