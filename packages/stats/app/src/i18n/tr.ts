export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | codeabz Data",
  "app.description":
    "codeabz Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde codeabz Data logosu",
  ...
  "header.githubAria": "GitHub'da codeabz'a yıldız ver",
  "header.github": "GitHub",
  "header.trycodeabz": "codeabz'u dene",
  ...
  "footer.homeAria": "codeabz ana sayfası",
  ...
  "home.topModelsDescription": "codeabz Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz codeabz Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | codeabz Data",
  "lab.description":
    "codeabz Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son codeabz kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "codeabz'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son codeabz kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük codeabz token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | codeabz Data",
  "model.description":
    "{{model}} için codeabz Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda codeabz Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki codeabz Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki codeabz Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde codeabz Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son codeabz Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz codeabz Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük codeabz Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz codeabz Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama codeabz Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan codeabz Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen codeabz Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son codeabz Go token hacmine göre yakındaki modeller.",
