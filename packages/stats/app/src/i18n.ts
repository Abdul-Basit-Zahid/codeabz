...
const en = {
  "app.title": "AI Model Usage Rankings | codeabz Data",
  "app.description":
    "Explore codeabz Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "codeabz Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star codeabz on GitHub",
  "header.github": "GitHub",
  "header.trycodeabz": "Try codeabz",
  ...
  "home.topModelsDescription": "Usage of models across codeabz Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique codeabz Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | codeabz Data",
  "lab.description":
    "Compare {{lab}} models used in codeabz Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent codeabz usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in codeabz",
  ...
  "lab.shareOfUsage": "{{share}} of recent codeabz usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | codeabz Data",
  "model.description":
    "View {{model}} codeabz Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. codeabz Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's codeabz Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's codeabz Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No codeabz Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no codeabz Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "codeabz Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No codeabz Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent codeabz Go token volume.",
