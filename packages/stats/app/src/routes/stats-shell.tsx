import codeabzWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/Abdul-Basit-Zahid/codeabz",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "codeabz:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://github.com/Abdul-Basit-Zahid/codeabz/">
            <strong>{i18n.t("header.trycodeabz")}</strong>
          </a>
          <button
...
function codeabzMark() {
  return (
    <svg data-slot="codeabz-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://github.com/Abdul-Basit-Zahid/codeabz/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://github.com/Abdul-Basit-Zahid/codeabz/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@github.com/Abdul-Basit-Zahid/codeabz", label: i18n.t("footer.contact") },
    { href: "https://github.com/Abdul-Basit-Zahid/codeabz/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/codeabz", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://github.com/Abdul-Basit-Zahid/codeabz" aria-label={i18n.t("footer.homeAria")}>
          <codeabzMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={codeabzWordmarkDark} alt="codeabz" />
          <button
