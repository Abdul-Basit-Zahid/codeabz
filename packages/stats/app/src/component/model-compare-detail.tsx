...
} from "@codeabz/stats-core/domain/home"
import { runtime } from "@codeabz/stats-core/runtime"
...
export default function ModelCompareDetailPage(props: ModelCompareDetailPageProps = {}) {
  ...
  const description = createMemo(() => {
    ...
    return `Compare ${models()[0].name} and ${models()[1].name} by usage, rank, context window, output limit, cache ratio, and cost across codeabz data.`
  })
  ...
  return (
    <main data-page="stats" data-layout="compare-detail" data-theme={themePreference()}>
      <Show when={catalog() !== undefined}>
        ...
        <Meta property="og:site_name" content="codeabz" />
