...
import { compile, emitEffectImported, emitPromise, write } from "@codeabz/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "codeabzEventEncoded",
              import: 'import type { codeabzEventEncoded } from "@codeabz/protocol/groups/event"',
            },
          },
        }),
