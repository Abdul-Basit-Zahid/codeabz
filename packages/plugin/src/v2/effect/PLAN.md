...
- Effect plugins import `@codeabz/plugin/v2/effect`, not `@codeabz/core`.
- Public domain values use generated `@codeabz/sdk` types.
...
- Define `PluginHost` domain capabilities in `@codeabz/plugin/v2/effect`.
