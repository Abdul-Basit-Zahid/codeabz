import { codeabz } from "@codeabz/client/effect"
...
import { createEmbeddedRoutes } from "@codeabz/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("codeabz.create")(function* () {
  ...
  const client = yield* codeabz.make({ baseUrl: "http://codeabz.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/sdk-next/codeabz") {}
