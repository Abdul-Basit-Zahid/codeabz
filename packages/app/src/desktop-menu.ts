...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "codeabz Documentation", href: "https://github.com/Abdul-Basit-Zahid/codeabz/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/codeabz" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/Abdul-Basit-Zahid/codeabz/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/Abdul-Basit-Zahid/codeabz/issues/new?template=bug_report.yml",
      },
    ],
  },
]
