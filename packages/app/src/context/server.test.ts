  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://codeabz.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://codeabz.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://codeabz.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://codeabz.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://codeabz.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://codeabz.example.com"),
      ),
    ).toEqual({
