...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: codeabzClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: codeabzClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: codeabzClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => codeabzClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, codeabzClient>()
