...
import { getFilename } from "@codeabz/core/util/path"
import { Session } from "@codeabz/sdk/v2/client"
...
import { toaster } from "@codeabz/ui/toast"
...
import { retry } from "@codeabz/core/util/retry"
...
import { useTheme, type ColorScheme } from "@codeabz/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/Abdul-Basit-Zahid/codeabz/desktop-feedback")}
      renderPanel={() =>
