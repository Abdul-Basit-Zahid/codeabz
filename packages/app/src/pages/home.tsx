...
import { Logo } from "@codeabz/ui/logo"
import { Spinner } from "@codeabz/ui/spinner"
import { ScrollView } from "@codeabz/ui/scroll-view"
import { ProjectAvatar } from "@codeabz/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@codeabz/core/util/encode"
...
import { useMarked } from "@codeabz/ui/context/marked"
import { preloadMarkdown } from "@codeabz/session-ui/markdown-cache"
    ...
    <div class="rounded-[10px] shadow-[var(--v2-elevation-raised)] m-2 min-h-0 lg:overflow-hidden bg-v2-background-bg-base self-stretch flex-1">
      <div class="mx-auto grid h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
        <HomeProjectColumn
          ...
          openHelp={() => platform.openLink("https://github.com/Abdul-Basit-Zahid/codeabz/desktop-feedback")}
          language={language}
        />
