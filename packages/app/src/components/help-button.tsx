...
export function HelpButton() {
  if (import.meta.env.VITE_CODEABZ_CHANNEL !== "dev") return null
  ...
  return (
    <a
      ...
      aria-label="Open the codeabz website"
      ...
      <DrawerContent>
        ...
        <div class="relative flex w-full flex-col items-start gap-6 p-8">
          ...
          <p class="w-full flex-1 text-[13px] font-[440] leading-5 tracking-[-0.04px] text-v2-text-text-base">
            We've introduced tabs as the primary navigation in codeabz. Your most important session are now pinned at
