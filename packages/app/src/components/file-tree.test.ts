...
beforeAll(async () => {
  ...
  mock.module("@codeabz/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codeabz/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codeabz/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codeabz/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
