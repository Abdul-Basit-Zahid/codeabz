...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "codeabz", key: "dialog.provider.codeabz.note" },
  { match: (id: string) => id === "codeabz-go", key: "dialog.provider.codeabzGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "codeabz" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "codeabz" || item.id === "codeabz-go"}>
