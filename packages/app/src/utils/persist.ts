...
const GLOBAL_STORAGE = "codeabz.global.dat"
const WINDOW_STORAGE = "codeabz.window"
const LOCAL_PREFIX = "codeabz."
...
function workspaceStorage(dir: string) {
  ...
  return `codeabz.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `codeabz.draft.${head}.${sum}.dat`
}
