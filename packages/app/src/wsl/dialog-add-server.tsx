...
import { showToast } from "@codeabz/ui/toast"
import { ButtonV2 } from "@codeabz/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@codeabz/ui/v2/dialog-v2"
import { DividerV2 } from "@codeabz/ui/v2/divider-v2"
import { LoaderV2 } from "@codeabz/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@codeabz/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-codeabz") {
      await run(() => api.installcodeabz(distro))
      return
    }
