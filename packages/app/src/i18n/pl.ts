export const dict = {
  ...
  "dialog.provider.codeabz.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codeabz.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codeabzGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez codeabz",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.codeabzZen.visit.prefix": "Odwiedź ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w codeabz.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codeabz.json",
  ...
  "dialog.server.description": "Przełącz serwer codeabz, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingcodeabz": "Sprawdzanie codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Sprawdzanie codeabz w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Aktualizowanie codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Aktualizowanie codeabz w dystrybucji {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Zaktualizuj codeabz w dystrybucji {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Zaktualizuj codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz jest gotowy.",
  "wsl.onboarding.installcodeabzIn": "Zainstaluj codeabz w dystrybucji {{distro}}.",
  "wsl.onboarding.installcodeabz": "Zainstaluj codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim codeabz będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "codeabz nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz codeabz.",
  ...
  "toast.update.description": "Nowa wersja codeabz ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu codeabz",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codeabz.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: codeabz nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "codeabz zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer codeabz wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla codeabz",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd codeabz na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy codeabz ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw codeabz.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania codeabz",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji codeabz.",
