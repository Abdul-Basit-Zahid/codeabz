export const dict = {
  ...
  "dialog.provider.codeabz.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.codeabz.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.codeabzGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "codeabzが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、codeabzで{{provider}}モデルを使用します。",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.codeabzZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.codeabzZen.visit.prefix": " ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してcodeabzで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、codeabzで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "codeabz.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するcodeabzサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingcodeabz": "codeabzを確認中...",
  "wsl.onboarding.checkingcodeabzIn": "{{distro}}内のcodeabzを確認中...",
  "wsl.onboarding.updatingcodeabz": "codeabzを更新中...",
  "wsl.onboarding.updatingcodeabzIn": "{{distro}}内のcodeabzを更新中...",
  "wsl.onboarding.updatecodeabzIn": "{{distro}}内のcodeabzを更新してください。",
  "wsl.onboarding.updatecodeabz": "codeabzを更新",
  "wsl.onboarding.codeabzReadyIn": "{{distro}}内のcodeabzの準備ができました。",
  "wsl.onboarding.codeabzReady": "codeabzの準備ができました。",
  "wsl.onboarding.installcodeabzIn": "{{distro}}にcodeabzをインストールしてください。",
  "wsl.onboarding.installcodeabz": "codeabzをインストール",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabzがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "codeabzでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、codeabzをもう一度開いてください。",
  ...
  "toast.update.description": "codeabzの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをcodeabzチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (codeabz.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: codeabzはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "codeabzには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でcodeabzサーバーを実行します。",
  ...
  "settings.general.row.language.description": "codeabzの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのcodeabzの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "codeabzがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "codeabzのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "codeabz の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "codeabz は最新バージョンです。",
