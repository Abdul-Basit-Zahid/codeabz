export const dict = {
  ...
  "dialog.provider.codeabz.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codeabz.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.codeabzGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo codeabz",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.codeabzZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.codeabzZen.visit.prefix": "Visite ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no codeabz.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codeabz.json",
  ...
  "dialog.server.description": "Trocar para qual servidor codeabz este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingcodeabz": "Verificando o codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Verificando o codeabz em {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Atualizando o codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Atualizando o codeabz em {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Atualize o codeabz em {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Atualizar o codeabz",
  "wsl.onboarding.codeabzReadyIn": "O codeabz está pronto em {{distro}}.",
  "wsl.onboarding.codeabzReady": "O codeabz está pronto.",
  "wsl.onboarding.installcodeabzIn": "Instale o codeabz em {{distro}}.",
  "wsl.onboarding.installcodeabz": "Instalar o codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o codeabz possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O codeabz não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o codeabz novamente.",
  ...
  "toast.update.description": "Uma nova versão do codeabz ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do codeabz",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codeabz.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: codeabz ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "codeabz inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor codeabz dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do codeabz",
  ...
  "settings.general.row.appearance.description": "Personalize como o codeabz aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o codeabz segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o codeabz é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o codeabz iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do codeabz.",
