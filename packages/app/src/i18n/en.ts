export const dict = {
  ...
  "dialog.provider.codeabz.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.codeabz.tagline": "Reliable optimized models",
  "dialog.provider.codeabzGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by codeabz",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in codeabz.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.codeabzZen.line1":
    "codeabz Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.codeabzZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.codeabzZen.visit.prefix": "Visit ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in codeabz.",
  ...
  "dialog.plugins.empty": "Plugins configured in codeabz.json",
  ...
  "dialog.server.description": "Switch which codeabz server this app connects to.",
  ...
  "wsl.onboarding.checkingcodeabz": "Checking codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Checking codeabz in {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Updating codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Updating codeabz in {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Update codeabz in {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Update codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz is ready in {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz is ready.",
  "wsl.onboarding.installcodeabzIn": "Install codeabz in {{distro}}.",
  "wsl.onboarding.installcodeabz": "Install codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before codeabz can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "codeabz could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen codeabz.",
  ...
  "toast.update.description": "A new version of codeabz ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the codeabz team",
  ...
  "error.chain.checkConfig": "Check your config (codeabz.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, codeabz does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "codeabz includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the codeabz server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for codeabz",
  ...
  "settings.general.row.appearance.description": "Customise how codeabz looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether codeabz follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how codeabz is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when codeabz launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of codeabz.",
