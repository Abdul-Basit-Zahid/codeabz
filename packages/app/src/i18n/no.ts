...
export const dict = {
  ...
  "dialog.provider.codeabz.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.codeabz.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.codeabzGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av codeabz",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.codeabzZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.codeabzZen.visit.prefix": "Besøk ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i codeabz.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i codeabz.json",
  ...
  "dialog.server.description": "Bytt hvilken codeabz-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av codeabz ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til codeabz-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codeabz.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at codeabz ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "codeabz inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør codeabz-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for codeabz",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan codeabz ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om codeabz skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan codeabz er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når codeabz starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av codeabz.",
  ...
  "wsl.onboarding.checkingcodeabz": "Sjekker codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Sjekker codeabz i {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Oppdaterer codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Oppdaterer codeabz i {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Oppdater codeabz i {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Oppdater codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz er klar i {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz er klar.",
  "wsl.onboarding.installcodeabzIn": "Installer codeabz i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før codeabz kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "codeabz kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter codeabz på nytt.",
