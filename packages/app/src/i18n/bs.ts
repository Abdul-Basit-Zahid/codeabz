export const dict = {
  ...
  "dialog.provider.codeabz.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codeabz.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codeabzGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje codeabz",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u codeabz-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u codeabz-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codeabz.json",
  ...
  "dialog.server.description": "Promijeni na koji se codeabz server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingcodeabz": "Provjera codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Provjera codeabz u distribuciji {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Ažuriranje codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Ažuriranje codeabz u distribuciji {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Ažuriraj codeabz u distribuciji {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Ažuriraj codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz je spreman.",
  "wsl.onboarding.installcodeabzIn": "Instaliraj codeabz u distribuciji {{distro}}.",
  "wsl.onboarding.installcodeabz": "Instaliraj codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi codeabz mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "codeabz nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori codeabz.",
  ...
  "toast.update.description": "Nova verzija codeabz-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku codeabz timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (codeabz.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: codeabz još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "codeabz uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni codeabz server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u codeabz-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako codeabz izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li codeabz prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu codeabz-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se codeabz pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju codeabz-a.",
