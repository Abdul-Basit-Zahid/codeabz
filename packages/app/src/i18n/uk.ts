export const dict = {
  ...
  "dialog.provider.codeabz.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.codeabz.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.codeabzGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від codeabz",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.codeabzZen.visit.prefix": "Відвідайте ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у codeabz.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в codeabz.json",
  ...
  "dialog.server.description": "Перемкніть сервер codeabz, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingcodeabz": "Перевірка codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Перевірка codeabz у {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Оновлення codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Оновлення codeabz у {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Оновіть codeabz у {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Оновити codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz готовий до роботи у {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz готовий до роботи.",
  "wsl.onboarding.installcodeabzIn": "Встановіть codeabz у {{distro}}.",
  "wsl.onboarding.installcodeabz": "Встановити codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в codeabz потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "codeabz не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте codeabz.",
  ...
  "toast.update.description": "Нова версія codeabz ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді codeabz",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (codeabz.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, codeabz ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "codeabz містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер codeabz всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу codeabz",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд codeabz на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи codeabz використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему codeabz.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску codeabz",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію codeabz.",
