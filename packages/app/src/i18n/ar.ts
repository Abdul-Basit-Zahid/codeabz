export const dict = {
  ...
  "dialog.provider.codeabz.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.codeabz.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.codeabzGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من codeabz",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "يمنحك codeabz Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.codeabzZen.visit.prefix": "قم بزيارة ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في codeabz.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في codeabz.json",
  ...
  "dialog.server.description": "تبديل خادم codeabz الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingcodeabz": "جارٍ التحقق من codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "جارٍ التحقق من codeabz في {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "جارٍ تحديث codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "جارٍ تحديث codeabz في {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "حدّث codeabz في {{distro}}.",
  "wsl.onboarding.updatecodeabz": "تحديث codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz جاهز في {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz جاهز.",
  "wsl.onboarding.installcodeabzIn": "ثبّت codeabz في {{distro}}.",
  "wsl.onboarding.installcodeabz": "تثبيت codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن codeabz من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على codeabz التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح codeabz.",
  ...
  "toast.update.description": "نسخة جديدة من codeabz ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق codeabz",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (codeabz.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن codeabz لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن codeabz نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم codeabz داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ codeabz",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور codeabz على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان codeabz يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة codeabz.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل codeabz",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من codeabz.",
