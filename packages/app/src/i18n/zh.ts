...
export const dict = {
  ...
  "dialog.provider.codeabz.note": "使用 codeabz Zen 或 API 密钥连接",
  "dialog.provider.codeabz.tagline": "可靠的优化模型",
  "dialog.provider.codeabzGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "codeabz 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 codeabz 中使用 {{provider}} 模型。",
  ...
  "provider.connect.codeabzZen.line1": "codeabz Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.codeabzZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.codeabzZen.visit.prefix": "访问 ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 codeabz 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 codeabz 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 codeabz.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 codeabz 服务器。",
  ...
  "wsl.onboarding.checkingcodeabz": "正在检查 codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "正在检查 {{distro}} 中的 codeabz...",
  "wsl.onboarding.updatingcodeabz": "正在更新 codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "正在更新 {{distro}} 中的 codeabz...",
  "wsl.onboarding.updatecodeabzIn": "更新 {{distro}} 中的 codeabz。",
  "wsl.onboarding.updatecodeabz": "更新 codeabz",
  "wsl.onboarding.codeabzReadyIn": "{{distro}} 中的 codeabz 已就绪。",
  "wsl.onboarding.codeabzReady": "codeabz 已就绪。",
  "wsl.onboarding.installcodeabzIn": "在 {{distro}} 中安装 codeabz。",
  "wsl.onboarding.installcodeabz": "安装 codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "未安装 codeabz",
  ...
  "wsl.onboarding.wslNotInstalled.description": "codeabz 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "codeabz 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 codeabz。",
  ...
  "toast.update.description": "codeabz 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 codeabz 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (codeabz.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: codeabz 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "codeabz 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 codeabz 服务器。",
  ...
  "settings.general.row.language.description": "更改 codeabz 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 codeabz 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 codeabz 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 codeabz 的主题。",
  ...
  "settings.updates.row.startup.description": "在 codeabz 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 codeabz。",
