export const dict = {
  ...
  "dialog.provider.codeabz.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.codeabz.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.codeabzGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af codeabz",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.codeabzZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.codeabzZen.visit.prefix": "Besøg ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i codeabz.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i codeabz.json",
  ...
  "dialog.server.description": "Skift hvilken codeabz-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingcodeabz": "Tjekker codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Tjekker codeabz i {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Opdaterer codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Opdaterer codeabz i {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Opdater codeabz i {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Opdater codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før codeabz kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "codeabz kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter codeabz igen.",
  ...
  "toast.update.description": "En ny version af codeabz ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til codeabz-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (codeabz.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, codeabz understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "codeabz inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør codeabz-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for codeabz",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan codeabz ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om codeabz følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan codeabz er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når codeabz starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af codeabz.",
