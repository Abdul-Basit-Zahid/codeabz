export const dict = {
  ...
  "dialog.provider.codeabz.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.codeabz.tagline": "Modèles optimisés et fiables",
  "dialog.provider.codeabzGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par codeabz",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.codeabzZen.visit.prefix": "Visitez ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans codeabz.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans codeabz.json",
  ...
  "dialog.server.description": "Changez le serveur codeabz auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingcodeabz": "Vérification d'codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Vérification d'codeabz dans {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Mise à jour d'codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Mise à jour d'codeabz dans {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Mettez à jour codeabz dans {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Mettre à jour codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz est prêt dans {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz est prêt.",
  "wsl.onboarding.installcodeabzIn": "Installez codeabz dans {{distro}}.",
  "wsl.onboarding.installcodeabz": "Installer codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'codeabz puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "codeabz n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez codeabz.",
  ...
  "toast.update.description":
    "Une nouvelle version d'codeabz ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe codeabz",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (codeabz.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'codeabz ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "codeabz inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur codeabz dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour codeabz",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'codeabz sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si codeabz suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'codeabz.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'codeabz",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'codeabz.",
