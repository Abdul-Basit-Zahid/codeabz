...
export const dict = {
  ...
  "dialog.provider.codeabz.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.codeabz.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.codeabzGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von codeabz",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in codeabz zu nutzen.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.codeabzZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.codeabzZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in codeabz zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in codeabz zu nutzen.",
  ...
  "dialog.plugins.empty": "In codeabz.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den codeabz-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.codeabz": "codeabz",
  ...
  "wsl.onboarding.checkingcodeabz": "codeabz wird geprüft...",
  "wsl.onboarding.checkingcodeabzIn": "codeabz in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingcodeabz": "codeabz wird aktualisiert...",
  "wsl.onboarding.updatingcodeabzIn": "codeabz in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updatecodeabzIn": "Aktualisieren Sie codeabz in {{distro}}.",
  "wsl.onboarding.updatecodeabz": "codeabz aktualisieren",
  "wsl.onboarding.codeabzReadyIn": "codeabz ist in {{distro}} bereit.",
  "wsl.onboarding.codeabzReady": "codeabz ist bereit.",
  "wsl.onboarding.installcodeabzIn": "Installieren Sie codeabz in {{distro}}.",
  "wsl.onboarding.installcodeabz": "codeabz installieren",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor codeabz einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "codeabz konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann codeabz erneut.",
  ...
  "toast.update.description": "Eine neue Version von codeabz ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem codeabz-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (codeabz.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: codeabz unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "codeabz enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "codeabz Desktop",
  ...
  "settings.desktop.wsl.description": "codeabz-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für codeabz ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie codeabz auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob codeabz dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von codeabz anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von codeabz automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von codeabz.",
