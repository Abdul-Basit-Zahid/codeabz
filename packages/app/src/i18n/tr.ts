...
export const dict = {
  ...
  "dialog.provider.codeabz.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codeabz.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.codeabzGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "codeabz tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve codeabz'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.codeabzZen.visit.prefix": "",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak codeabz'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak codeabz'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codeabz.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi codeabz sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingcodeabz": "codeabz kontrol ediliyor...",
  "wsl.onboarding.checkingcodeabzIn": "{{distro}} içinde codeabz kontrol ediliyor...",
  "wsl.onboarding.updatingcodeabz": "codeabz güncelleniyor...",
  "wsl.onboarding.updatingcodeabzIn": "{{distro}} içinde codeabz güncelleniyor...",
  "wsl.onboarding.updatecodeabzIn": "{{distro}} içindeki codeabz'u güncelleyin.",
  "wsl.onboarding.updatecodeabz": "codeabz'u güncelle",
  "wsl.onboarding.codeabzReadyIn": "{{distro}} içinde codeabz hazır.",
  "wsl.onboarding.codeabzReady": "codeabz hazır.",
  "wsl.onboarding.installcodeabzIn": "codeabz'u {{distro}} içine kurun.",
  "wsl.onboarding.installcodeabz": "codeabz'u kur",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "codeabz'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "codeabz bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından codeabz'u tekrar açın.",
  ...
  "toast.update.description": "codeabz'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı codeabz ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (codeabz.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: codeabz henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "codeabz ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "codeabz Masaüstü",
  ...
  "settings.desktop.wsl.description": "codeabz sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "codeabz'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "codeabz'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "codeabz'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "codeabz'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "codeabz başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "codeabz'un en son sürümünü kullanıyorsunuz.",
