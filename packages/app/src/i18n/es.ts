export const dict = {
  ...
  "dialog.provider.codeabz.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.codeabz.tagline": "Modelos optimizados y fiables",
  "dialog.provider.codeabzGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por codeabz",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en codeabz.",
  ...
  "provider.connect.codeabzZen.line1":
    "codeabz Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.codeabzZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.codeabzZen.visit.prefix": "Visita ",
  "provider.connect.codeabzZen.visit.link": "github.com/Abdul-Basit-Zahid/codeabz/zen",
  "provider.connect.codeabzZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en codeabz.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en codeabz.",
  ...
  "dialog.plugins.empty": "Plugins configurados en codeabz.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de codeabz se conecta esta app.",
  ...
  "wsl.onboarding.checkingcodeabz": "Comprobando codeabz...",
  "wsl.onboarding.checkingcodeabzIn": "Comprobando codeabz en {{distro}}...",
  "wsl.onboarding.updatingcodeabz": "Actualizando codeabz...",
  "wsl.onboarding.updatingcodeabzIn": "Actualizando codeabz en {{distro}}...",
  "wsl.onboarding.updatecodeabzIn": "Actualiza codeabz en {{distro}}.",
  "wsl.onboarding.updatecodeabz": "Actualizar codeabz",
  "wsl.onboarding.codeabzReadyIn": "codeabz está listo en {{distro}}.",
  "wsl.onboarding.codeabzReady": "codeabz está listo.",
  "wsl.onboarding.installcodeabzIn": "Instala codeabz en {{distro}}.",
  "wsl.onboarding.installcodeabz": "Instalar codeabz",
  ...
  "wsl.onboarding.distroStatus.codeabzMissing": "codeabz no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que codeabz pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "codeabz no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir codeabz.",
  ...
  "toast.update.description": "Una nueva versión de codeabz ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de codeabz",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (codeabz.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, codeabz no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "codeabz incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor codeabz dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para codeabz",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve codeabz en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si codeabz sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de codeabz.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia codeabz",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de codeabz.",
