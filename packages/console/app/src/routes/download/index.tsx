...
import desktopAppIcon from "../../asset/lander/codeabz-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://github.com/Abdul-Basit-Zahid/codeabz/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>github.com/Abdul-Basit-Zahid/codeabz/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g codeabz")}>
                <code>
                  npm i -g <strong>codeabz</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g codeabz")}>
                <code>
                  bun add -g <strong>codeabz</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/codeabz")}>
                <code>
                  brew install <strong>anomalyco/tap/codeabz</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S codeabz")}>
                <code>
                  paru -S <strong>codeabz</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask codeabz-desktop")}>
                <code>
                  brew install --cask <strong>codeabz-desktop</strong>
                </code>
                <CopyStatus />
              </button>
