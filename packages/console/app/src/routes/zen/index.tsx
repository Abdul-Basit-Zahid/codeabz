...
import compareVideo from "../../asset/lander/codeabz-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/codeabz-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="codeabz:auth" content={loggedin() ? "true" : "false"} />
