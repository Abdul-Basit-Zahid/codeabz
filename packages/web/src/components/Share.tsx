...
import { Iconcodeabz } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "codeabz/session/message-v2"
import type { Message } from "codeabz/session/message"
import type { Session } from "codeabz/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.CODEABZ_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.CODEABZ_name}>
                    <Iconcodeabz width={16} height={16} />
                  </div>
