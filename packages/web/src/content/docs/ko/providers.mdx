...
1. TUI에서 `/connect` 명령을 실행하고 `OpenCode Zen`을 선택한 뒤, [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `OpenCode Go`를 선택한 뒤 [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen)로 이동하십시오.
