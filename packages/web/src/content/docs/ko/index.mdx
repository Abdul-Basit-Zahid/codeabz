...
[Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases)에서 바이너리를 직접 받아 설치할 수도 있습니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `opencode`를 선택한 다음 [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth)로 이동합니다.
...
다음은 OpenCode [대화 예시](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5)입니다.
