...
server/runtime config schema는 [**`github.com/Abdul-Basit-Zahid/codeabz/config.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/config.json)에 정의되어 있습니다.

TUI config는 [**`github.com/Abdul-Basit-Zahid/codeabz/tui.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/tui.json)을 사용합니다.
