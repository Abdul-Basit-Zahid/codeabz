...
[Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. TUI で `/connect` コマンドを実行し、opencode を選択して、[github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth) で認証します。
...
これは [OpenCode を使用した会話 ](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) の例です。
