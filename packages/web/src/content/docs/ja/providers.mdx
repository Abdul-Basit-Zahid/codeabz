...
1. TUI で `/connect` コマンドを実行し、`OpenCode Zen` を選択して、[github.com/Abdul-Basit-Zahid/codeabz/zen](https://github.com/Abdul-Basit-Zahid/codeabz/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`OpenCode Go` を選択して、[github.com/Abdul-Basit-Zahid/codeabz/zen](https://github.com/Abdul-Basit-Zahid/codeabz/zen) にアクセスします。
