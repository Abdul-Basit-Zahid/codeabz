...
サーバー/ランタイム構成スキーマは [**`github.com/Abdul-Basit-Zahid/codeabz/config.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/config.json) で定義されています。

TUI 設定は [**`github.com/Abdul-Basit-Zahid/codeabz/tui.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/tui.json) を使用します。
