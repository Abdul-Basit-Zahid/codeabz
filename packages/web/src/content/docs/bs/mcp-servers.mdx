...
Možete definirati MCP servere u vašoj [OpenCode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
