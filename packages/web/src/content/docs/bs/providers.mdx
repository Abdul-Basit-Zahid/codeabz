...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `OpenCode Go` i idite na [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen).
