...
Također možete preuzeti binarnu datoteku iz [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
:::
Evo [primjer razgovora](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) sa OpenCode.
