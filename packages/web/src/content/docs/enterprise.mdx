...
export const enterprise = "https://github.com/Abdul-Basit-Zahid/codeabz/enterprise"
...
If a user enables the `/share` feature, the conversation and the data associated with it are sent to the service we use to host these share pages at github.com/Abdul-Basit-Zahid/codeabz.
