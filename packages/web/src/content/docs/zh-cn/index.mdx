...
你也可以从 [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases) 页面直接下载二进制文件。
...
1. 在 TUI 中运行 `/connect` 命令，选择 opencode，然后前往 [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth)。
...
这是一个与 OpenCode 的[示例对话](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5)。
