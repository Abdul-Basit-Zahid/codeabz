...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCode Zen`，然後前往 [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `OpenCode Go`，然後前往 [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen)。
