...
您也可以從 [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases) 頁面直接下載二進位檔案。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 opencode，然後前往 [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth)。
...
這是一個與 OpenCode 的[範例對話](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5)。
