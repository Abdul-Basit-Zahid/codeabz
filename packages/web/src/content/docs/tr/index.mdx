...
İkili dosyayı [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases)'dan da alabilirsiniz.
...
1. TUI'de `/connect` komutunu çalıştırın, OpenCode'u seçin ve [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth)'ye gidin.
...
İşte OpenCode ile bir [örnek konuşma](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5).
