...
MCP sunucularını [opencode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/)'nizde `mcp` altında tanımlayabilirsiniz. Her MCP'ü benzersiz bir adla ekleyin. LLM isteminde bulunurken bu MCP adına başvurabilirsiniz.
