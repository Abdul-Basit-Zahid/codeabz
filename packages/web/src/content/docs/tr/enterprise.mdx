...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını github.com/Abdul-Basit-Zahid/codeabz'de barındırmak için kullandığımız hizmete gönderilir.
