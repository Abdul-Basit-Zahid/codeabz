...
También puede obtener el binario desde [Versiones](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Ejecute el comando `/connect` en la TUI, seleccione opencode y diríjase a [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Aquí tiene una [conversación de ejemplo](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) con OpenCode.
