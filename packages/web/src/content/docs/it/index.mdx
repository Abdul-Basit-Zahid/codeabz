...
Puoi anche scaricare il binario dalle [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Esegui il comando `/connect` nella TUI, seleziona opencode e vai su [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Ecco un'[esempio di conversazione](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) con OpenCode.
