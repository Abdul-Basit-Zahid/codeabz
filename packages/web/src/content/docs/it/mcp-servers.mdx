...
Puoi definire server MCP nella tua [OpenCode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.
