...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`github.com/Abdul-Basit-Zahid/codeabz/config.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/config.json)

การกำหนดค่า TUI ใช้ [**`github.com/Abdul-Basit-Zahid/codeabz/tui.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/tui.json)
