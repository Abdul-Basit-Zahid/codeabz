...
Você também pode baixar o binário na seção [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Aqui está uma [conversa de exemplo](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) com o opencode.
