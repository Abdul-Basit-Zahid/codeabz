...
O esquema de configuração do servidor/tempo de execução é definido em [**`github.com/Abdul-Basit-Zahid/codeabz/config.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/config.json).

A configuração do TUI usa [**`github.com/Abdul-Basit-Zahid/codeabz/tui.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/tui.json).
