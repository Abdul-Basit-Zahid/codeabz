...
Die Konfigurationsdatei verfügt über ein Schema, das in [**`github.com/Abdul-Basit-Zahid/codeabz/config.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/config.json) definiert ist.
