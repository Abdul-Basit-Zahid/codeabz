...
Sie können den MCP-Server in Ihrem [OpenCode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) unter `mcp` definieren. Fügen Sie jedem MCP einen eindeutigen Namen hinzu. Sie können bei der Eingabe von LLM namentlich auf diesen MCP verweisen.
