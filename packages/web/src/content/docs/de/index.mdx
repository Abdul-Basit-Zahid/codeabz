...
Sie können die Binärdatei auch aus [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases) abrufen.
...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie OpenCode aus und gehen Sie zu [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Hier ist ein [Beispielgespräch](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) mit OpenCode.
