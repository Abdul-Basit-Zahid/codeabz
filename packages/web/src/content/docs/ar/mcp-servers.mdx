...
يمكنك تعريف خوادم MCP في [إعدادات OpenCode](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) ضمن `mcp`. أضف كل خادم MCP باسم فريد. ويمكنك الإشارة إلى ذلك الخادم بالاسم عند توجيه الطلب إلى الـ LLM.
