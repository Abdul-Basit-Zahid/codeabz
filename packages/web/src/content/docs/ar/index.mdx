...
يمكنك أيضا تنزيل الملف التنفيذي من صفحة [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. شغّل الأمر `/connect` في واجهة TUI، واختر opencode، ثم انتقل إلى [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
إليك [مثالا لمحادثة](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) مع OpenCode.
