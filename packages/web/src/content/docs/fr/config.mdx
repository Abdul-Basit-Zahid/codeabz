...
Le fichier de configuration a un schéma défini dans [**`github.com/Abdul-Basit-Zahid/codeabz/config.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/config.json).

La configuration TUI utilise [**`github.com/Abdul-Basit-Zahid/codeabz/tui.json`**](https://github.com/Abdul-Basit-Zahid/codeabz/tui.json).
