...
- **Via Mise**
  ...
  ```bash
  mise use -g github:Abdul-Basit-Zahid/codeabz
  ```

- **Via Docker**

  ```bash
  docker run -it --rm ghcr.io/Abdul-Basit-Zahid/codeabz
  ```

Le support de l'installation de OpenCode sur Windows à l'aide de Bun est actuellement en cours de développement.

Vous pouvez également récupérer le binaire dans les [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et allez sur [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Voici un [exemple de conversation](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) avec OpenCode.
