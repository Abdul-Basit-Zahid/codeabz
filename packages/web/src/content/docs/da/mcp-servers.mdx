...
Du kan definere MCP-servere i din [OpenCode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) under `mcp`. Tilføj hver MCP med et unikt navn. Du kan henvise til denne MCP ved navn, når du spørger LLM.
