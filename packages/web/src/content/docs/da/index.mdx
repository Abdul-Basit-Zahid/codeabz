...
Du kan også få fat i binæren fra [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Kør kommandoen `/connect` i TUI, vælg opencode, og gå til [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Her er en [eksempelsamtale](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) med OpenCode.
