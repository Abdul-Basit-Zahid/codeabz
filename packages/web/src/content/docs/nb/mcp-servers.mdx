...
Du kan definere MCP-servere i [OpenCode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) under `mcp`. Legg til hver MCP med et unikt navn. Du kan referere til den MCP ved navn når du spør LLM-en.
