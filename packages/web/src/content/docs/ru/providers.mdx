...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Zen` и перейдите по адресу [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen).
...
1. Запустите команду `/connect` в TUI, выберите `OpenCode Go` и перейдите по адресу [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/zen).
