...
Вы также можете получить бинарный файл в разделе [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Вот [пример диалога](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) с opencode.
