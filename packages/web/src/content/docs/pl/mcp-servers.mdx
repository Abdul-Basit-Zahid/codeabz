...
Dostępny serwery MCP w [opencode Config](https://github.com/Abdul-Basit-Zahid/codeabz/docs/config/) w `mcp`. Dodaj każdy MCP z unikalną nazwą. Możesz zgłosić się do tego MCP po nazwie, pytając LLM.
