...
Możesz także pobrać plik binarny z [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Oto [przykładowa rozmowa](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) z opencode.
