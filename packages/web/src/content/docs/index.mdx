...
You can also grab the binary from the [Releases](https://github.com/Abdul-Basit-Zahid/codeabz/releases).
...
1. Run the `/connect` command in the TUI, select opencode, and head to [github.com/Abdul-Basit-Zahid/codeabz/auth](https://github.com/Abdul-Basit-Zahid/codeabz/auth).
...
Here's an [example conversation](https://github.com/Abdul-Basit-Zahid/codeabz/s/4XP1fce5) with OpenCode.
