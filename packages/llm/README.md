...
Schema-first LLM core for codeabz. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@codeabz/llm"
import { OpenAI } from "@codeabz/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@codeabz/llm/providers"
