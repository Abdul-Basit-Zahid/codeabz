...
Practical reference for the current tool-migration state in `packages/codeabz`.
...
Tool tests should use the existing Effect helpers in `packages/codeabz/test/lib/effect.ts`:
