...
import { makeGlobalNode } from "@codeabz/core/effect/app-node"
...
import { InstallationChannel } from "@codeabz/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/codeabz/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/codeabz/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/codeabz/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("anomalyco/tap/codeabz")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("codeabz")) return "codeabz"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("anomalyco/tap/codeabz") && args.includes("--formula")) return "codeabz"
