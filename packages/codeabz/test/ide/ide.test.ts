...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODEABZ_CALLER", () => {
    process.env["CODEABZ_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODEABZ_CALLER", () => {
    process.env["CODEABZ_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODEABZ_CALLER", () => {
    process.env["CODEABZ_CALLER"] = "unknown"
