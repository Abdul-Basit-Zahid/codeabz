...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips codeabz-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-codeabz-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-codeabz-directory")).toBeNull()
      expect(result.get("x-codeabz-workspace")).toBeNull()
