...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips codeabz-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-codeabz-directory"]).toBeUndefined()
      expect(forwarded["x-codeabz-workspace"]).toBeUndefined()
