...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codeabz.git")).toEqual({ owner: "sst", repo: "codeabz" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/codeabz")).toEqual({ owner: "sst", repo: "codeabz" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codeabz.git")).toEqual({ owner: "sst", repo: "codeabz" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/codeabz")).toEqual({ owner: "sst", repo: "codeabz" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codeabz.git")).toEqual({ owner: "sst", repo: "codeabz" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/codeabz")).toEqual({ owner: "sst", repo: "codeabz" })
})
