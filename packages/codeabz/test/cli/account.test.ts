...
describe("console account display", () => {
  test("uses console.github.com/Abdul-Basit-Zahid/codeabz as the default login URL", () => {
    expect(defaultConsoleUrl).toBe("https://console.github.com/Abdul-Basit-Zahid/codeabz")
  })
