 ...
 *   "@codeabz/ServerAuthConfig",
 *   {
 *     password: Config.string("CODEABZ_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODEABZ_SERVER_USERNAME").pipe(Config.withDefault("codeabz")),
 *   },
 * ) {}
 *
