...
import { ProjectDirectoryTable, ProjectTable } from "@codeabz/core/project/sql"
import { ProjectDirectories } from "@codeabz/core/project/directories"
...
import { which } from "@codeabz/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CODEABZ_FAKE_VCS)
