...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "codeabz-gitlab-auth"
import { PoeAuthPlugin } from "codeabz-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Plugin") {}
