import type { Hooks, PluginInput } from "@codeabz/plugin"
import type { Model } from "@codeabz/sdk/v2"
import { InstallationVersion } from "@codeabz/core/installation/version"
import { OauthCallbackPage } from "@codeabz/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. codeabz will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
