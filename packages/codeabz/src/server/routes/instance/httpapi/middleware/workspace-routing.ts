...
>()("@codeabz/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@codeabz/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CODEABZ_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CODEABZ_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-codeabz-directory"] || process.cwd()
}
