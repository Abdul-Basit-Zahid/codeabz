...
import { makeApi } from "@codeabz/protocol/api"
import { LocationMiddleware } from "@codeabz/server/location"
import { SessionLocationMiddleware } from "@codeabz/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("codeabz-root")
...
export const InstanceHttpApi = HttpApi.make("codeabz-instance")
...
export const codeabzHttpApi = HttpApi.make("codeabz")
