...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@codeabz/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@codeabz/ACPDirectory") {}
