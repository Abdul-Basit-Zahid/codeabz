...
import type { AssistantMessage as codeabzAssistantMessage, Message } from "@codeabz/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@codeabz/core/effect/app-node"
...
export type AssistantTokenCost = Pick<codeabzAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<codeabzAssistantMessage, "role"> &
  Partial<Pick<codeabzAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@codeabz/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@codeabz/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@codeabz/ACPUsage") {}
