...
import type * as SDK from "@codeabz/sdk/v2"
...
import { SessionShareTable } from "@codeabz/core/share/sql"
import { ProviderV2 } from "@codeabz/core/provider"
import { ModelV2 } from "@codeabz/core/model"
import { EventV2 } from "@codeabz/core/event"

const disabled = process.env["CODEABZ_DISABLE_SHARE"] === "true" || process.env["CODEABZ_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/ShareNext") {}
