...
import { EventSequenceTable, EventTable } from "@codeabz/core/event/sql"
...
import { WorkspaceEvent } from "@codeabz/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CODEABZ_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CODEABZ_WORKSPACE_ID: config.id,
        CODEABZ_EXPERIMENTAL_WORKSPACES: "true",
