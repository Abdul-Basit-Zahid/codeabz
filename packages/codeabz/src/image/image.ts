...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CODEABZ_PHOTON_WASM_PATH?: string }).__CODEABZ_PHOTON_WASM_PATH =
