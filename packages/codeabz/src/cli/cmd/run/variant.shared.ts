...
//
// The saved variant persists across sessions in ~/.local/state/codeabz/model.json
...
class Service extends Context.Service<Service, VariantService>()("@codeabz/RunVariant") {}
