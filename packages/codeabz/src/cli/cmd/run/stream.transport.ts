...
import type { Event, GlobalEvent, codeabzClient } from "@codeabz/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@codeabz/RunStreamTransport") {}
