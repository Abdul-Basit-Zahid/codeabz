...
import { normalizePromptContent } from "@codeabz/tui/editor"
...
import { CODEABZ_BASE_MODE, useBindings } from "@codeabz/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close codeabz" } satisfies SlashOption,
    ]
