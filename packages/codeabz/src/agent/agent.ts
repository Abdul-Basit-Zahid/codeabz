...
import { AbsolutePath, type DeepMutable } from "@codeabz/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".codeabz", "plans", "*.md")]: "allow",
