import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@codeabz/llm"
...
// Move this extraction into @codeabz/llm when Copilot is handled by the native runtime.
