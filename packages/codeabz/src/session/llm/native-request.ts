import type { JsonSchema, LLMRequest, ProviderMetadata } from "@codeabz/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@codeabz/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @codeabz/llm request objects from codeabz's session/AI SDK-shaped data.
  return LLM.request({
