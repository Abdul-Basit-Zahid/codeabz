...
import { locationServiceMapLayer } from "@codeabz/core/location-services"
...
import { PartTable, SessionTable } from "@codeabz/core/session/sql"
...
import { NonNegativeInt, optional } from "@codeabz/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".codeabz", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Session") {}
