...
import type { Definition } from "@codeabz/schema/event"
...
export const codeabzEvent = event.schema
export type codeabzEvent = typeof codeabzEvent.Type
export type codeabzEventEncoded = typeof codeabzEvent.Encoded
