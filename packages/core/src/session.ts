...
import { ListAnchor } from "@codeabz/schema/session"
...
import { SessionDurable } from "@codeabz/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/v2/Session") {}
