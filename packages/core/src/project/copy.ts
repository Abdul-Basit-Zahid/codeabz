...
import { Event } from "@codeabz/schema/project-directories"
import { ProjectCopy } from "@codeabz/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/ProjectCopy") {}
