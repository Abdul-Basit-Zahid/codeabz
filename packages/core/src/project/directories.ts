...
import type { EffectDrizzleSqlite } from "@codeabz/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/ProjectDirectories") {}
