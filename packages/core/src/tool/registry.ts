...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@codeabz/llm"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/v2/ToolRegistry") {}
