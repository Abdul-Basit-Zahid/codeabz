...
export class Service extends Context.Service<Service, Interface>()("@codeabz/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.CODEABZ_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
