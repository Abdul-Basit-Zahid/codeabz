...
import { FileSystemWatcher } from "@codeabz/schema/filesystem-watcher"
...
declare const CODEABZ_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CODEABZ_LIBC === "undefined" ? undefined : CODEABZ_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CODEABZ_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CODEABZ_EXPERIMENTAL_FILEWATCHER)) {
