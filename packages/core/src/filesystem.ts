...
import { Entry, FileSystem, FindInput, Match } from "@codeabz/schema/filesystem"
export { Entry, Match, Submatch } from "@codeabz/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/v2/FileSystem") {}
