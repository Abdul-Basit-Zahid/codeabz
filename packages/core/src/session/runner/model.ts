...
import { type Model } from "@codeabz/llm"
import * as AnthropicMessages from "@codeabz/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@codeabz/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@codeabz/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@codeabz/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/v2/SessionRunnerModel") {}
