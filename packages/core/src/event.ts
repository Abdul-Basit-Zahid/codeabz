...
import type { Data, Definition, Payload } from "@codeabz/schema/event"
...
import { Durable } from "@codeabz/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@codeabz/schema/event").ID
export type { Data, Definition, Payload } from "@codeabz/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@codeabz/Event") {}
