...
import { ProviderPlugins } from "@codeabz/core/plugin/provider"
import { ZenmuxPlugin } from "@codeabz/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/Abdul-Basit-Zahid/codeabz/", "X-Title": "codeabz" })
