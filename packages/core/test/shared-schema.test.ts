...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@codeabz/schema/prompt"
import { Provider } from "@codeabz/schema/provider"
import { Project } from "@codeabz/schema/project"
import { ProjectDirectories } from "@codeabz/schema/project-directories"
import { PermissionV1 } from "@codeabz/schema/permission-v1"
...
import { Command } from "@codeabz/schema/command"
import { Connection } from "@codeabz/schema/connection"
import { Credential } from "@codeabz/schema/credential"
import { FileSystem } from "@codeabz/schema/filesystem"
import { Integration } from "@codeabz/schema/integration"
import { LLM } from "@codeabz/schema/llm"
import { Permission } from "@codeabz/schema/permission"
import { Plugin } from "@codeabz/schema/plugin"
import { Pty } from "@codeabz/schema/pty"
import { Reference } from "@codeabz/schema/reference"
import { SessionTodo } from "@codeabz/schema/session-todo"
import { Skill } from "@codeabz/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@codeabz/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@codeabz/core/command"),
    import("@codeabz/core/integration/connection"),
    import("@codeabz/core/credential"),
    import("@codeabz/core/filesystem"),
    import("@codeabz/core/integration"),
    import("@codeabz/core/location"),
    import("@codeabz/llm"),
    import("@codeabz/core/permission"),
    import("@codeabz/core/v1/permission"),
    import("@codeabz/core/project/copy"),
    import("@codeabz/core/pty"),
    import("@codeabz/core/project/schema"),
    import("@codeabz/core/reference"),
    import("@codeabz/core/session/input"),
    import("@codeabz/core/session/message"),
    import("@codeabz/core/session/todo"),
    import("@codeabz/core/session/prompt"),
    import("@codeabz/core/skill"),
    import("@codeabz/core/v2-schema"),
    import("@codeabz/core/schema"),
    import("@codeabz/core/workspace"),
  ])
