...
declare const CODEABZ_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CODEABZ_CLI_NAME === "string" ? CODEABZ_CLI_NAME : "codeabz", {
  description: "codeabz 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
