...
# Package managers
npm i -g codeabz@latest        # or bun/pnpm/yarn
scoop install codeabz             # Windows
choco install codeabz             # Windows
brew install anomalyco/tap/codeabz # macOS and Linux (recommended, always up to date)
brew install codeabz              # macOS and Linux (official brew formula, updated less)
sudo pacman -S codeabz            # Arch Linux (Stable)
paru -S codeabz-bin               # Arch Linux (Latest from AUR)
mise use -g codeabz               # Any OS
nix run nixpkgs#codeabz           # or github:Abdul-Basit-Zahid/codeabz for latest dev branch
```
...
codeabz ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/Abdul-Basit-Zahid/codeabz/releases) অথবা [github.com/Abdul-Basit-Zahid/codeabz/download](https://github.com/Abdul-Basit-Zahid/codeabz/download) থেকে ডাউনলোড করুন।
...
1. `$codeabz_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.codeabz/bin` - ডিফল্ট ফলব্যাক
...
codeabz এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://github.com/Abdul-Basit-Zahid/codeabz/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে codeabz কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://github.com/Abdul-Basit-Zahid/codeabz/docs)।

### অবদান (Contributing)

আপনি যদি codeabz এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### codeabz এর উপর বিল্ডিং (Building on codeabz)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা codeabz এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "codeabz" ব্যবহার করেন, উদাহরণস্বরূপ "codeabz-dashboard" বা "codeabz-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি codeabz দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/codeabz) | [X.com](https://x.com/codeabz)
