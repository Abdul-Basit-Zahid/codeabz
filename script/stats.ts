...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Abdul-Basit-Zahid/codeabz/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Abdul-Basit-Zahid/codeabz...\n")
...
console.log("Fetching npm all-time downloads for codeabz...\n")
const npmDownloads = await fetchNpmDownloads("codeabz")
