...
Generates UPCOMING_CHANGELOG.md by running the codeabz changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for codeabz run (default: low)
      --quiet            Suppress codeabz command output unless it fails
